...
#define PDL_IIC_10_BIT_SLAVE_ADDRESS		0x0010u

/* Master DMAC / DTC trigger control */
#define PDL_IIC_DMAC_DTC_TRIGGER_DISABLE	0x0020u
#define PDL_IIC_DMAC_TRIGGER_ENABLE			0x0040u
#define PDL_IIC_DTC_TRIGGER_ENABLE			0x0080u

/* Slave DMAC / DTC trigger control */
#define PDL_IIC_RX_DMAC_DTC_TRIGGER_DISABLE	0x0100u
#define PDL_IIC_RX_DMAC_TRIGGER_ENABLE		0x0200u
#define PDL_IIC_RX_DTC_TRIGGER_ENABLE		0x0400u
#define PDL_IIC_TX_DMAC_DTC_TRIGGER_DISABLE	0x0800u
#define PDL_IIC_TX_DMAC_TRIGGER_ENABLE		0x1000u
#define PDL_IIC_TX_DTC_TRIGGER_ENABLE		0x2000u
