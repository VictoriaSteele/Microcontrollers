...
/* History    : V1.4  (2013-04-01)  [Hardware Manual Revision : 1.40]           */
/*            : V1.4B (2013-04-08)  RPDL version:								*/
/*			  : 	Added EXSYSTEM: MDEB, MDES, OFS1 and OFS0.					*/
/*			  : V1.4C (2013-05-03) Added RTC.RCR2.Reserved						*/
/*																				*/
...
/*       #pragma interrupt INT_TPU0_TGI0A(vect=VECT(TPU0,TGIA0))  expands to :  */
...
#define	SMCI11	(*(volatile struct st_smci   __evenaccess *)0x8A160)
